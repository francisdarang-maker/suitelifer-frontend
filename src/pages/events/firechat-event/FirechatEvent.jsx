          ...
          <div className="speaker-info-right">
            ...
            <MotionUp delay={0.3}>
              <h6 className="speaker-title-right">
                Head of Bus Dev (Aumni), VP Digital Private Market (JP Morgan),
                Head of GTM (Lumonic), Investmen Analyst (Epic Ventures)
              </h6>
            </MotionUp>
            <MotionUp delay={0.4}>
