...
import noUrlImg from "../../assets/images/woman-laptop.svg";
...
<main className="px-[5%]">
  <div className="md:px-5 lg:px-20 xl:px-50">
    <div className="flex flex-col items-center justify-center space-y-4 text-sm p-10 md:p-12 lg:p-15 xl:px-50 shadow-sm border-primary border-1 rounded-lg bg-white text-center">
      <img
        src={isValidURL(assessmentUrl) ? congratsImg : noUrlImg}
        alt={isValidURL(assessmentUrl) ? "Congratulations" : "No Assessment Yet"}
        className="w-24 md:w-35"
      />

      <p className="text-lg md:text-2xl lg:text-4xl font-avenir-black text-primary">
        {isValidURL(assessmentUrl) ? "Congratulations!" : "Welcome!"}
      </p>
      ...
      {isValidURL(assessmentUrl) ? (
        <>
          <p className="text-gray-600 text-[12px] md:text-[14px] lg:text-base md:mb-7">
            ...
            link below to start your pre-assessment. It will take 1 hour and 30
            minutes or shorter depending on you.
          </p>
          <div className="hidden lg:block"></div>
          <p className="text-gray-600 text-[12px] md:text-[14px] lg:text-base">
            If you have no time now, you can take it later. Just open your email
            inbox and click the link we have sent you there. Hope the best for
            your initial test! Fighting!!
          </p>
          <a
            href={assessmentUrl}
            target="_blank"
        ...
        <>
          ...
          <div className="hidden lg:block"></div>
          <p className="text-gray-600 text-[12px] md:text-[14px] lg:text-base">
            Browse our available job postings and apply to get started. Our team
            will review your application and get in touch with you soon.
            <br />
