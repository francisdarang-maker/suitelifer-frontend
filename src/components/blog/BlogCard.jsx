...
const BlogCard = ({ blog, isMine = false, onDelete }) => {
  ...
  const renderImageGrid = () => {
    ...
    // Three images - equal height columns
    if (imageCount === 3) {
      return (
  ...
  // Get valid images
  const validImages =
    blog?.images?.filter((img) => img && img.trim() !== "") || [];
    ...
    <>
            ...
            >
              ...
              <div className="p-6">
                <p className="text-gray-600 leading-relaxed">
                  ...
                  permanently remove the post, including all images, likes, and
                  comments.
                </p>
              </div>
      ...
      >
        ...
        {validImages.length > 0 && (
          <div
            onClick={(e) => e.stopPropagation()}
            className="max-h-96 overflow-hidden rounded-xl"
          >
            {renderImageGrid()}
          </div>
        )}
