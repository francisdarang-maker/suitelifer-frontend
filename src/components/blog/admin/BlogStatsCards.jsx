    ...
    <>
      <div className="bg-white rounded-2xl shadow-lg p-6 border border-slate-200 hover:scale-102 transition ease-linear">
        <div className="flex items-center justify-between">
          ...
          <div className="p-3 bg-blue-100 rounded-xl lg:hidden flex">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 border border-slate-200 hover:scale-102 transition ease-linear">
        <div className="flex items-center justify-between">
          ...
          <div className="p-3 bg-indigo-100 rounded-xl lg:hidden flex">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 border border-slate-200 hover:scale-102 transition ease-linear">
        <div className="flex items-center justify-between">
          ...
          <div className="p-3 bg-red-100 rounded-xl lg:hidden flex">
