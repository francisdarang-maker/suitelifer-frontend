...
//     const found = articles.find((a) => a.section === sectionNumber);
//     return found && found.article?.trim() ? found : null;
//     return (
...
//   const section1 = getArticleBySection(articles, 1) ?? null;
//   const section2 = getArticleBySection(articles, 2) ?? null;
//   const section3 = getArticleBySection(articles, 3) ?? null;
//   const section4 = getArticleBySection(articles, 4) ?? null;
//   const section5 = getArticleBySection(articles, 5) ?? null;
//   const section6 = getArticleBySection(articles, 6) ?? null;
//   const section7 = getArticleBySection(articles, 7) ?? null;
//   return (
//     <div>
//       {
//         isLoading ? (
...
//         )
//         //  : (
//         //   newsletterContent.currentIssue?.assigned ===
//         //   7
//           (
//             <section>
//               <MotionUp>
...
//                       }
//                       datePublished={
//                         formatTimestamp(section5.createdAt).fullDate
//                       }
...
//                         <div className="">
//                           <p
//                             className={`font-avenir-black text-h6 line-clamp-2`}
//                           >
//                             {section6.title}
//                           </p>
//                           <p className="text-small pb-3 pt-1">
